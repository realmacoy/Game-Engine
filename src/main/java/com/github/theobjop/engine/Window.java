...
public class Window {
    ...
    private void init() {
        ...
        glfwSetKeyCallback(windowHandle, InputHandler.getKeyboardHandler());
        glfwSetMouseButtonCallback(windowHandle, InputHandler.getMouseHandler());
        glfwSetCursorPosCallback(windowHandle, InputHandler.getCursorHandler());
        glfwSetScrollCallback(windowHandle, InputHandler.getScrollHandler());
        ...
        // Setup the Assimp logger (required)
        AILogStream stream = AILogStream.create().set((message, user) -> System.out.println(Assimp.aiGetErrorString()), AILogStream.USER);
        Assimp.aiAttachLogStream(stream);
    }
