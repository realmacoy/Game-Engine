...
public class InstancedMesh extends Mesh {
    ...
    public void renderListInstanced(List<GameObject> gameItems, Transformation transformation, Matrix4f viewMatrix, Matrix4f lightViewMatrix) {
        renderListInstanced(gameItems, false, transformation, viewMatrix, lightViewMatrix);
    }

    public void renderListInstanced(List<GameObject> gameItems, boolean billBoard, Transformation transformation, Matrix4f viewMatrix, Matrix4f lightViewMatrix) {
        initRender();
        ...
        for (int i = 0; i < length; i += chunkSize) {
            ...
            List<GameObject> subList = gameItems.subList(i, end);
    ...
    private void renderChunkInstanced(List<GameObject> gameItems, boolean billBoard, Transformation transformation, Matrix4f viewMatrix, Matrix4f lightViewMatrix) {
