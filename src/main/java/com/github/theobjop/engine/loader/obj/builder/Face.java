...
public class Face {
    ...
    public ArrayList<FaceVertex> indices = new ArrayList<FaceVertex>();
    ...
    /* Assume that face is a triangle */
    /*
    public void calculateTriangleNormal() {
        float[] edge1 = new float[3];
        float[] edge2 = new float[3];
        float[] normal = new float[3];
        VertexGeometric v1 = indices.get(0).v;
        VertexGeometric v2 = indices.get(1).v;
        VertexGeometric v3 = indices.get(2).v;
    ...
    */
    ...
    public String toString() { 
        String result = "\tvertices: "+indices.size()+" :\n";
        for(FaceVertex f : indices) {
            result += " \t\t( "+f.toString()+" )\n";
        }
        return result;
    }
