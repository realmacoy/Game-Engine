...
public class MD5AnimModel {
    ...
    public static MD5AnimModel parse(String animFile) {
        List<String> lines = Util.readAllLines(animFile);
    ...
    private static void parseBlock(MD5AnimModel model, String blockId, List<String> blockBody) {
        switch (blockId) {
            case "hierarchy":
